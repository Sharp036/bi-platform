...
export const CHART_TYPE_OPTIONS = [
  ...
  { value: 'funnel', i18nKey: 'charts.type.funnel', icon: '🔻' },
  { value: 'gauge', i18nKey: 'charts.type.gauge', icon: '🎯' },
  { value: 'sankey', i18nKey: 'charts.type.sankey', icon: '🌊' },
  { value: 'boxplot', i18nKey: 'charts.type.boxplot', icon: '📦' },
  { value: 'waterfall', i18nKey: 'charts.type.waterfall', icon: '💧' },
  { value: 'candlestick', i18nKey: 'charts.type.candlestick', icon: '🕯️' },
]
