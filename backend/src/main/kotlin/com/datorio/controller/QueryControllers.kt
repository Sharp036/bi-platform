...
import com.datorio.service.SavedQueryService
import com.datorio.service.SchemaService
...
class QueryAuditController(
    ...
    fun getExecutionHistory(
        ...
        val filter = QueryExecutionFilter(
            ...
            status = status?.let { com.datorio.model.ExecutionStatus.valueOf(it.uppercase()) },
            from = from, to = to,
            page = page, size = size
        )
