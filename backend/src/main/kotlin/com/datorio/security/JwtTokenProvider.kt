...
class JwtTokenProvider(
    @Value("\${datorio.jwt.secret}") private val jwtSecret: String,
    @Value("\${datorio.jwt.access-token-expiration}") private val accessExpiration: Long,
    @Value("\${datorio.jwt.refresh-token-expiration}") private val refreshExpiration: Long
) {
