package com.datalens.datasource

import com.datalens.model.DataSource
import com.datalens.model.DataSourceType
import com.datalens.model.dto.ColumnMeta
import com.datalens.model.dto.ConnectionTestResult
...
class ConnectionManager {
    ...
    private fun extractValue(rs: ResultSet, index: Int): Any? {
        ...
        return if (rs.wasNull()) null else value?.toString()  // serialize to string for JSON safety
    }
}
