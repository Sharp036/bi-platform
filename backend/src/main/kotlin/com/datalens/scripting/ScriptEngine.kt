package com.datalens.scripting
...
@Component
class ScriptEngine(
    @SpringValue("\${datalens.scripting.timeout-ms:5000}") private val timeoutMs: Long,
    @SpringValue("\${datalens.scripting.max-statements:100000}") private val maxStatements: Long
) {
